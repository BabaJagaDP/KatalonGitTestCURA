...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_15'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/img_From_ui-datepicker-trigger'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_22'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/input_All_leaveList_chkSearchFilter_checkbo_a698f3'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_OrangeHRM/select_AllAdministrationEngineeringDevelopm_a385e1'), 
    '2', true)

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/input_Include Past Employees_leaveListcmbWi_465e62'))
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Welcome SdmnSdmnSdmn'))
